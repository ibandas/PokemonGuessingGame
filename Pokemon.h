...
public:
	Pokemon(); //default constructor, default private variables to respective defaults, 0's for nums, NULL for char arrays, NULL terminator for char
	Pokemon(int pID, string pName, string MT, string OT, string A1, string A2, string A3, string A4, string Att1, string Att2, int Evo); //assign variables with parameters given by the user
	~Pokemon(); //if there is any variables that are made dynamically release there memory look at rectangle_example_dynamic.cp for assistance
